  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: 'John Doe meminta jadwal konsultasi untuk tanggal 15 Januari 2024',
    ...
    },
    {
      id: '2',
      title: 'Pesan Baru',
      message: 'Anda mendapat pesan baru dari Jane Smith',
    ...
    },
    {
      ...
      message: 'Mahasiswa telah mengonfirmasi jadwal konsultasi besok',
